      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <input
            ...
            required
            disabled={disabled}
            className="w-full pl-10 p-3 bg-gray-700/70 border border-gray-600 rounded-lg text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-gray-800"
