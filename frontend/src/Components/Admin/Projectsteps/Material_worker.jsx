...
const MaterialForm = ({
  ...
  return (
    <div className="text-gray-200 p-2 lg:p-5">
      <div className="lg:max-w-4xl max-w-3xl mx-auto bg-gray-800 rounded-xl shadow-2xl lg:p-8 p-2 backdrop-filter backdrop-blur-lg bg-opacity-30 border border-gray-700">
